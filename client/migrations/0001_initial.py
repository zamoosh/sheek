    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_file', models.ImageField(blank=True, null=True, upload_to=client.models.user_image)),
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to=client.models.user_image)),
                ('gender', models.BooleanField(default=True)),
                ('has_jobField', models.BooleanField(default=False)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('state', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='state.state')),
